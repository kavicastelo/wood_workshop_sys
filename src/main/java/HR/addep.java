 ...
 * @author KAVI
 */
public class addep extends javax.swing.JFrame {

    /**
     * Creates new form addep
     */
    int xMouse;
    int yMouse;
    public addep() {
    ...
    private void btndoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndoneActionPerformed
        ...
        try
        {
            FileWriter Writer = new FileWriter("C:\\Users\\KAVI\\Desktop\\Departments.txt",true);
            Writer.write(dep+"\t"+des+"\r\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
